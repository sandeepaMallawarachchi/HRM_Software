...
const UpdateTeamModel = ({ teamName, onClose }) => {
    ...
    const handleSave = async () => {
        try {
            ...
            await axios.post(
                `https://global-hrm-mobile-server.vercel.app/admin/updateTeam/${creatorEmpId}`,
                newTeamData
            );
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg p-8 w-2/3 shadow-lg">
                <h2 className="text-2xl font-semibold mb-4">Update Team: {teamName}</h2>
