...
const NewTrainingAllocation = ({ selectedTraining, selectedTrainingWeight, onClose }) => {
    ...
    const handleSave = async () => {
        if (!selectedEmployee || !allocatedDate || !selectedTraining) {
        ...
        try {
            ...
            alert("Failed to allocate training.");
        }
    };
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg p-8 w-2/3 shadow-lg max-h-[95vh] overflow-y-auto">
                <h2 className="text-2xl font-semibold mb-4">Allocate Training</h2>
                <div className="mt-6">
...
export default NewTrainingAllocation;