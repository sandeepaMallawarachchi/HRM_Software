      ...
      <div className="flex space-x-6 mt-4">
        <button
          ...
          className={`py-2 px-4 border border-orange-500 rounded-full text-orange-500 hover:bg-orange-500 hover:text-white transition-all ${
            visibleSection === "payslip" ? "bg-orange-500 text-white" : ""
          }`}
        >
          Payslip
        </button>
        <button
          ...
          className={`py-2 px-4 border border-orange-500 rounded-full text-orange-500 hover:bg-orange-500 hover:text-white transition-all ${
            visibleSection === "payrollAssitance"
        ...
        <button
          ...
          className={`py-2 px-4 border border-orange-500 rounded-full text-orange-500 hover:bg-orange-500 hover:text-white transition-all ${
            visibleSection === "salaryandloan" ? "bg-orange-500 text-white" : ""
          }`}
        >
        ...
        <button
          ...
          className={`py-2 px-4 border border-orange-500 rounded-full text-orange-500 hover:bg-orange-500 hover:text-white transition-all ${
            visibleSection === "finacialrequest"
              ? "bg-orange-500 text-white"
              : ""
          }`}
        >
        ...
        <button
          onClick={() => handleSectionToggle("taxcalculator")}
          className={`py-2 px-4 border border-orange-500 rounded-full text-orange-500 hover:bg-orange-500 hover:text-white transition-all ${
            visibleSection === "taxcalculator" ? "bg-orange-500 text-white" : ""
          }`}
        >
          Tax Calculator
        </button>
