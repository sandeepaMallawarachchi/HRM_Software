...
import logo from "../images/hrm withoutbackground.png"; // Assuming logo.png is in the /images folder
...
const Payroll = () => {
  ...
  const handleDownloadPDF = () => {
    ...
    img.onload = () => {
      ...
      const totalEarnings =
        employeeData.basic + employeeData.bonus + employeeData.ot;
      const totalDeductions =
        employeeData.providentFund +
      ...
      // Footer
      doc.text("This is a system-generated payslip.", 105, 190, {
        align: "center",
      });
